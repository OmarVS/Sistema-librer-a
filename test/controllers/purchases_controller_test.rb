...
class PurchasesControllerTest < ActionController::TestCase
  ...
  test "should create purchase" do
    assert_difference('Purchase.count') do
      post :create, purchase: { amount: @purchase.amount, name: @purchase.name, price: @purchase.price }
    end
  ...
  test "should update purchase" do
    patch :update, id: @purchase, purchase: { amount: @purchase.amount, name: @purchase.name, price: @purchase.price }
    assert_redirected_to purchase_path(assigns(:purchase))
  end
