...
User.create!([{:name => 'admin1', :password => '123123', :email => 'brauliopuentes1995@hotmail.es', :password_confirmation => '123123', :kind => 'admin'},
  {:name => 'omarvs', :password => '123123', :email => 'prueba@test.cl', :password_confirmation => '123123', :kind => 'seller'},
  {:name => 'mariom', :password => '123123', :email => 'test@test.cl', :password_confirmation => '123123', :kind => 'client'} ])
Book.create!([
